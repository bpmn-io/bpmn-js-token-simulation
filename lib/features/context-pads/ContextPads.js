...
ContextPads.prototype._updateElementContextPads = function(element, handler) {
  ...
  for (const contextPad of contextPads) {
    ...
    if (_action) {
      ...
      /*
       * click and keydown events are registered separately, so that focus can return to the canvas
       * for clicks to enable global SPACE pause/play and other keyboard shortcuts.
       */
      ...
      domEvent.bind(html, 'keydown', event => {
