...
function TokenCount(eventBus, overlays, elementRegistry, canvas) {
  ...
  eventBus.on([ GENERATE_TOKEN_EVENT, CONSUME_TOKEN_EVENT ], LOW_PRIORITY, function(context) {
    ...
    self.removeTokenCounts(scope);
    self.addTokenCounts(scope);
  });
}

TokenCount.prototype.addTokenCounts = function(scope) {
  var self = this;
...
TokenCount.prototype.removeTokenCounts = function(scope) {
  var self = this;
