...
ElementColors.prototype.get = function(element) {
  ...
  const fill = element.businessObject.di.get('background-color');
  const stroke = element.businessObject.di.get('border-color');
...
ElementColors.prototype.set = function(element, colors) {
  ...
  element.businessObject.di.set('background-color', fill);
  element.businessObject.di.set('border-color', stroke);
